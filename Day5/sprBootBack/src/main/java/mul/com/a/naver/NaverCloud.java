...
public class NaverCloud {
	...
	public static String processSTT(String filepath) {
		...
		String clientId = "zw625ksmw6";             // Application Client ID";
        String clientSecret = "ey0v4xC0riYf4TrIsQwLW11F7zX6guatq1uUYFTY";     // Application Client Secret";
	...
	public static String processCFR(String filepath) {
		
		StringBuffer reqStr = new StringBuffer();
        String clientId = "zw625ksmw6";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "ey0v4xC0riYf4TrIsQwLW11F7zX6guatq1uUYFTY";//애플리케이션 클라이언트 시크릿값";
	...
	public static String processObjDetect(String filepath) {
